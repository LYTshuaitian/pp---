...
chrome.runtime.onInstalled.addListener(function(details) {
    ...
    if (details.reason == "update" && thisVersion == '2.1') {
        chrome.tabs.create({url: chrome.extension.getURL('updateNotify.html')});
    }
});
    
var mp = new mp();mp.background();
